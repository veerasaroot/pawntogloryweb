...
export default async function LessonPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
       <div className="flex-shrink-0 p-4 border-b border-white/10 flex items-center gap-4">
          <Link href={`/course/${courseId}`} className="p-2 hover:bg-white/10 rounded-full transition-colors">
       ...
       <div className="flex-1 flex flex-col items-center justify-center bg-zinc-900">
         {lesson.video_url ? (
           <div className="w-full max-w-5xl aspect-video bg-black rounded-lg overflow-hidden shadow-2xl relative">
             {/* Mock Video Player - In PROD use real embed */}
           ...
           <div className="text-center p-12">
             <p className="text-muted-foreground">Video source not found or pending upload.</p>
           </div>
         )}
       </div>
    </div>
